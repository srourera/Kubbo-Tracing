...
describe('StocksTableComponent', function () {
    var table;
    var fixture;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [stocks_table_component_1.StocksTableComponent]
                    })
                        .compileComponents()];
                case 1:
                    _a.sent();
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(stocks_table_component_1.StocksTableComponent);
        table = fixture.componentInstance;
        table.stocks = app_data_spec_1.emptyStockList;
    ...
    describe('ngOnChanges', function () {
        it('should retrieve warehouses', function () {
            // Given 
            table.stocks = app_data_spec_1.stockList;
            // When
            table.ngOnChanges();
            // Then
            expect(table.stockDataSource.data.length).toBe(app_data_spec_1.stockList.length);
        });
    });
    ...
    describe('editStock', function () {
        it('should emit edit event', function () {
            ...
            // Then
            expect(table.edit.emit).toHaveBeenCalledWith(app_data_spec_1.fullStock);
        });
    });
    describe('deleteStock', function () {
        it('should emit edit event', function () {
            ...
            // Then
            expect(table["delete"].emit).toHaveBeenCalledWith(app_data_spec_1.fullStock);
        });
    });
});
